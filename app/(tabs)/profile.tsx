...
export default function ProfileScreen() {
          ...
          { text: 'Отмена', style: 'cancel' },
          {
            ...
            onPress: async () => {
              ...
              if (result.error) {
                ...
                // ИСПРАВЛЕНИЕ ЗДЕСЬ: Принудительно перенаправляем на страницу входа
  ...
  const handleNotifications = () => {
    showAlert(
      'Уведомления',
      'Настройка push-уведомлений о дедлайнах и рекомендациях ИИ будет доступна в следующих обновлениях.',
  ...
  const handleTheme = () => {
    showAlert(
      'Тема оформления',
      'Темная и светлая темы будут добавлены в ближайших обновлениях. Сейчас используется светлая тема.',
      [{ text: 'Понятно', style: 'default' }]
    );
  };
  ...
  const handleDataSync = () => {
    showAlert(
      ...
      'Ваши задачи автоматически синхронизируются в облаке. Все данные защищены и доступны на всех ваших устройствах.',
    ...
    <SafeAreaView style={styles.container}>
      <ScrollView style={styles.content} showsVerticalScrollIndicator={false}>
        <View style={styles.header}>
          ...
          <Text style={styles.userName}>{user?.email || 'Пользователь'}</Text>
        ...
        <View style={styles.menuContainer}>
          ...
          <TouchableOpacity style={styles.menuItem} onPress={handleTheme}>
            <MaterialIcons name="palette" size={24} color="#757575" />
            <Text style={styles.menuText}>Тема</Text>
            <MaterialIcons name="chevron-right" size={24} color="#BDBDBD" />
          </TouchableOpacity>

          <TouchableOpacity style={styles.menuItem} onPress={handleDataSync}>
            <MaterialIcons name="backup" size={24} color="#757575" />
            <Text style={styles.menuText}>Данные и синхронизация</Text>
            <MaterialIcons name="chevron-right" size={24} color="#BDBDBD" />
          </TouchableOpacity>

          <TouchableOpacity style={styles.menuItem} onPress={handleHelp}>
            <MaterialIcons name="help" size={24} color="#757575" />
          ...
          <TouchableOpacity style={styles.menuItem} onPress={handleAbout}>
            ...
            <Text style={styles.menuText}>О программе</Text>
            <MaterialIcons name="chevron-right" size={24} color="#BDBDBD" />
          </TouchableOpacity>
        </View>
