// components/ui/WeeklyCalendar.tsx -- ПОЛНЫЙ КОД ФАЙЛА
  ...
  if (loading) {
    return (
        <View style={[styles.container, { paddingTop: insets.top }]}>
          <View style={styles.loadingContainer}><Text style={styles.loadingText}>Loading your tasks...</Text></View>
        </View>
    );
  }
          ...
          {weekDays.map((day) => (
              <View key={day.date.toISOString()} style={styles.dayColumn}>
                ...
                <ScrollView style={styles.taskList} showsVerticalScrollIndicator={false} contentContainerStyle={styles.taskListContent}>
                  ...
                  {day.tasks.length === 0 && (<View style={styles.emptyDayContainer}><Text style={styles.emptyDayText}>No tasks</Text></View>)}
                </ScrollView>
              </View>
          ))}
        </ScrollView>
